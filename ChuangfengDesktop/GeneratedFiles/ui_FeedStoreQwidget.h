...
public:
    ...
    void setupUi(QWidget *FeedStore)
    {
        ...
        FeedStore->resize(960, 647);
        verticalLayout = new QVBoxLayout(FeedStore);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(1, 1, 1, 1);
        feedstore_title = new QWidget(FeedStore);
        feedstore_title->setObjectName(QStringLiteral("feedstore_title"));
        feedstore_title->setMinimumSize(QSize(0, 40));
        feedstore_title->setMaximumSize(QSize(16777215, 40));
        feedstore_title->setStyleSheet(QStringLiteral("background-color: rgb(56, 59, 67);"));
        horizontalLayout_2 = new QHBoxLayout(feedstore_title);
        ...
        feedstore_min_btn = new QPushButton(feedstore_title);
        ...
        feedstore_max_restore_btn = new QPushButton(feedstore_title);
        ...
        feedstore_cose_btn = new QPushButton(feedstore_title);
        ...
        verticalLayout->addWidget(feedstore_title);
        ...
        feedstore_stackedWidget->setStyleSheet(QStringLiteral("background-color: rgb(68, 71, 77);"));
        page_6 = new QWidget();
